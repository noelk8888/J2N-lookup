        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-card border rounded-xl shadow-lg p-8 text-center">
                <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-primary/10 flex items-center justify-center">
                    <img src="/favicon.jpg" alt="J2N" className="w-14 h-14 rounded-full" />
                </div>
                <h1 className="text-2xl font-bold text-foreground mb-2">J2N LookUp</h1>
                <p className="text-muted-foreground mb-8">
                    Sign in to access the inventory lookup system
                </p>
                <button
